...
class _MultiPlayerScreenState extends State<MultiPlayerScreen>
  ...
  void initState() {
    ...
    // Força a tela deitada e ativa o modo imersivo total (esconde relógio, bateria e docks)
  ...
  void dispose() {
    ...
    // Devolve o comportamento padrão ao sair do player (tela em pé com as barras do Android visíveis)
